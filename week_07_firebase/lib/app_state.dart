...
class AppState extends ChangeNotifier {
  ...
  void updateTodo({required Todo todo}) {
    if (user == null) {
      throw StateError('Cannot update a todo when user is null');
    }
  ...
  void deleteTodo({required Todo todo}) {
    if (user == null) {
      throw StateError('Cannot delete a todo when user is null');
    }
  ...
  void addTodo({
    ...
    if (user == null) {
      throw StateError('Cannot add a todo when user is null');
    }
